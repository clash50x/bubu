...
export default function LongDistanceWebsite() {
  ...
  const memories = [
    { image: "https://images.unsplash.com/photo-1516589178581-6cd7833ae3b2?auto=format&fit=crop&w=600&q=80", caption: "Our favorite sunset walk" },
    { image: "https://images.unsplash.com/photo-1522673607200-164d1b6ce486?auto=format&fit=crop&w=600&q=80", caption: "Remember this coffee date?" },
    { image: "https://images.unsplash.com/photo-1518199266791-5375a83190b7?auto=format&fit=crop&w=600&q=80", caption: "Counting down to moments like this" },
  ];
    ...
    <main className="min-h-screen bg-[#FDFBF7] text-[#5C4033] flex flex-col items-center justify-center p-6 selection:bg-pink-100 font-sans relative overflow-hidden">
      ...
      {step === 2 && (
        <motion.div 
          ...
          className="text-center max-w-md flex flex-col items-center"
        >
          <h2 className="text-3xl font-bold text-stone-700 mb-6 font-serif">225km between us</h2>
      ...
      {step === 3 && (
        ...
        >
          ...
          >
            ...
            >
              <div className="text-[5.5rem] sm:text-[6rem] font-black text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-rose-400 tracking-[-0.08em] mb-2 font-serif leading-none">229</div>
